%number songs from 1 to 729 as in ground_truth.csv
%save ground_truth.csv as ground_truth.xlsx

addpath ./Data/software/ma
n=729; %number of songs
...
[num,txt]=xlsread('./Data/ground_truth.xlsx');
Name=txt(:,1);
TrackName=cell(20*729,1);
TrackNumber=cell(20*729,1);
MFCCNumber=zeros(20*729,1);
Frame=zeros(20*729,j);
for k=1:729
